const developers = [
  ...
  // const getProject = (developers)=>{

  //   developers.forEach(single=>{
  //     single.projects.forEach(item=>{   
  ...
  //   for(let x=0;x<developers[i].projects.length;x++){
  //     console.log(developers[i].projects[x])
  //   }
  // }
...
getDeveloperProjects(developers,projects,"d2");
